...
// functions/send-contact-email/send-contact-email.js
var send_contact_email_exports = {};
__export(send_contact_email_exports, {
  default: () => send_contact_email_default
});
...
var handler = async (event) => {
  ...
  let info = await transporter.sendMail({
    ...
    text: "Hello world?",
    html: "This email is sent through <b>GMAIL SMTP SERVER</b>"
  });
  console.log("Message sent: %s", info.messageId);
};
var send_contact_email_default = { handler };
